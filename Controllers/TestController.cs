...
namespace MvcTestApplication.Controllers {
    public class TestController : Controller {
        ...
        //[MvcSiteMapNode(ParentKey = "Home", Key = "Operation1.1 hack", Title = "Operation 1.1 hack", Attributes = "{id:\"Method1\", method:\"Method2\"}")]//hack of MyAuthorize
        [MyAuthorize]
        public ActionResult Operation1(Methods id) {
            return View("Message", (object)(MethodBase.GetCurrentMethod().Name + " Method = " + id.ToString()));
        }
        ...
        public ActionResult Operation2(Methods method) {
            return View("Message", (object)(MethodBase.GetCurrentMethod().Name + " Method = " + method.ToString()));
        }
